...
import StackedBarChartPage from 'infovis/containers/Chart/pages/StackedBarChart'
...
const AppRoutes = props => {
  return (
    <Switch>
      ...
      <PropsRoute path='/chart/basic/stackedbar' component={StackedBarChartPage} {...props} />
